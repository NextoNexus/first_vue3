    ...
    <div class="input-grid">
      <div class="input-item">
        ...
        <div class="input-area" :class="{ 'error-border': validationStatus.unitName.isError }">
          <el-input v-model="props.table.projectInfo.unitName" size="small"
      ...
      <div class="input-item">
        ...
        <div class="input-area" :class="{ 'error-border': validationStatus.unitType.isError }">
          <el-select v-model="props.table.projectInfo.unitType" :disabled="isOwner != undefined && !isOwner"
      ...
      <div class="input-item">
        <div class="input-label">
          <label><span class="required-mark">*</span>牵头部门（需求科室）：</label>
          
          <div v-if="validationStatus.departName.isError" class="error-message">{{ validationStatus.departName.message }}</div>
        </div>
        <div class="input-area" :class="{ 'error-border': validationStatus.departName.isError }">
          <el-input v-model="props.table.projectInfo.departName" size="medium"
            :disabled="isOwner != undefined && !isOwner" maxlength="50" @input="validateChineseEnglishInput($event, 'departName')"></el-input>
        </div>
      </div>
      <div class="input-item">
        <div class="input-label">
      ...
      <div class="input-item">
        <label>项目启动时间：</label>
        <div class="input-area">
          <el-date-picker v-model="props.table.projectInfo.startTime" type="date" value-format="YYYY-MM-DD"
            size="medium" :disabled="isOwner != undefined && !isOwner" :prefix-icon="TimeIcon"></el-date-picker>
        </div>
      </div>
    </div>
...
console.log('路由组件传入的props.isOwner为===', props.isOwner);
...
const validationStatus:any = reactive({
  ...
  departName: { isError: false, message: '' },
