<template>
    <div class="container">
        <div class="project-header">
            <a v-if="props.RouteAction=='search'" @click="router.back()" class="header-link">
                个人计划
            </a>
            <a v-else @click="router.back()" class="header-link">
                工作台
            </a>
                ...
                <div v-for="(table, index) in parentTables" :key="table.id" class="parent-table" ref="ref_parentTables">
                    ...
                    <div class="custom-panel">
                        <div class="panel-content">
                            ...
                            <div class="action-area">
                                ...
                                <div class="task-control" v-if="isOwner">
                                    <el-select v-model="currentAction" placeholder="更多操作" :suffix-icon='SelectIcon'
                                        @change="handleActionChange(index)" :disabled="!isOwner">
                                        <el-option label="下一步" value="complete" v-if="table.projectInfo.status != 'PAUSE' && table.projectID != '' && table.tasks[table.tasks.length - 1].status != 'FINISHED'"></el-option>
                    ...
                    <div class="table-content">
                        ...
                        <EducationSystemADetail v-if="props.workbenchDetailType == 'EDUCATION_SYSTEM_A_CUSTOMER'"
                            :table="table" :projectTypes="projectTypes" :isOwner="isOwner"
                        ...
                        <PartnerFollowUpDetail v-if="props.workbenchDetailType == 'PARTNER_FOLLOW_UP'" :table="table"
                            :projectTypes="projectTypes" :isOwner="isOwner" @saveProjectEvent="saveProject" />
                            ...
                            <div class="app-container">
                                        ...
                                        <el-table-column label="协调" align="center">
                                            <template #default="{ row }">
                                                <el-button class="coordination-btn" @click="openCoordination(row)"
                                                    v-if="isOwner" :disabled="table.projectInfo.status == 'PAUSE'">
                                                    <i class="fas fa-users"></i> 进入协调
                                                </el-button>
                                                <span v-else>仅负责人可操作</span>
                                            </template>
                                        </el-table-column>
                                    </el-table>
                                </div>
                                <div class="footer-panel">
                                    <el-button class="add-btn" style="position: relative; left: 41px;"
                                        @click="openAddForm"
                                        :disabled="table.projectID=='' || table.projectInfo.status == 'PAUSE'" v-if="isOwner">
        ...
        <el-dialog v-model="newCoordinationVisible" title="新增协调记录" width="700px" class="rounded-dialog">
            <el-form :model="newCoordination" class="new-coordination-form" label-width="80px">
                ...
                <label>协调内容</label>
                <el-form-item style="margin-bottom: 24px">
                    <el-input v-model="newCoordination.content" type="textarea" rows="4" :maxlength="textMaxLength" placeholder="请输入填写"
                        show-word-limit>
                    </el-input>
                </el-form-item>
            ...
            <div class="form-container">
                ...
                <el-form :model="newRecord" label-width="0px" ref="addForm">
                    ...
                    <el-form-item class="record-input-area" prop="record" style="margin-bottom: 24px">
                        <el-input class="record" v-model="newRecord.record" type="textarea" :rows="3" placeholder="请输入填写"
                            :maxlength="textMaxLength" show-word-limit>
                        </el-input>
                    </el-form-item>
                    <label for="">预期目标</label>
                    <el-form-item class="record-input-area" style="margin-bottom: 24px;">
                        <el-input class="predict-target" v-model="newRecord.predictTarget" type="textarea" :rows="2" placeholder="请输入填写"
                            :maxlength="50" show-word-limit>
                        </el-input>
                    </el-form-item>
                    <label for="">下一步计划</label>
                    <el-form-item class="record-input-area" style="margin-bottom: 24px">
                        <el-input class="next-plan" v-model="newRecord.nextPlan" type="textarea" :rows="2" placeholder="请输入填写"
                            :maxlength="textMaxLength" show-word-limit>
                        </el-input>
                    </el-form-item>
                    <!-- 其他表单项保持类似结构 -->
        ...
        <el-dialog v-model="detailDialogVisible" title="跟进记录" width="800px" class="rounded-dialog">
            <div class="form-container">
                ...
                <el-form :model="currentRecordDetail" label-width="0px" ref="addForm" :disabled="!isEditing">
                    ...
                    <label for="">记录内容</label>
                    <el-form-item class="record-input-area" prop="record" style="margin-bottom: 24px">
                        <el-input class="record" v-model="currentRecordDetail.record" type="textarea" :rows="3" placeholder="请输入填写"
                            :maxlength="textMaxLength" show-word-limit>
                        </el-input>
                    </el-form-item>
                    <label for="">预期目标</label>
                    <el-form-item class="record-input-area" style="margin-bottom: 24px">
                        <el-input class="predict-target" v-model="currentRecordDetail.predictTarget" type="textarea" :rows="2"
                            placeholder="请输入填写" :maxlength="50" show-word-limit>
                        </el-input>
                    </el-form-item>
                    <label for="">下一步计划</label>
                    <el-form-item class="record-input-area" style="margin-bottom: 24px">
                        <el-input class="next-plan" v-model="currentRecordDetail.nextPlan" type="textarea" :rows="2" placeholder="请输入填写"
                            :maxlength="textMaxLength" show-word-limit>
                        </el-input>
                    </el-form-item>
                </el-form>
            ...
            <div class="form-container">
                <el-form :model="deliverRecord" class="deliver-form" label-width="0px" ref="deliverForm">
                    ...
                    <el-form-item prop="transmitTime" style="margin-bottom: 24px">
                        <!-- <el-input v-model="deliverRecord.transmitTime" type="text" :rows="1" class="deliver-time">
                            <template #prefix>
                                <img src="./icon/日历1.png" style="height: 32px; width: 32px; margin-left: 8px;" />
                            </template>
                        </el-input> -->
...
// 初始化连接线
onMounted(() => {
    console.log('workBenchProjectDetail.vue组件初始化完成');
